...
#batch_size = 64
# Used batch size = 4 for my env that cpu is 10700K and 32GB memory
batch_size = 4
...
def model_convert_to_onnx(onnx_filepath):
    input_shape=(1,3,224,224) 
    onnx_file = onnx_filepath + '.onnx'
    params = onnx_filepath + '-0000.params' 
    sym = onnx_filepath + '-symbol.json' 
...
def main():
    ...
    net.export('/volume/' + model_name)
    model_convert_to_onnx('/volume/' + model_name)
